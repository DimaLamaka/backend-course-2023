...
@ExtendWith({TestInstancePostProcessorExtension.class})
...
//@ExtendWith({NumberFormatExceptionHandlerExecution.class})
@Tag("DEV")
class ExtensionsTest {
    ...
    @Test
    @Tag("new")
    void testGenerateUuidTestInfo(
//            @CustomRandom Integer value
    ) {
