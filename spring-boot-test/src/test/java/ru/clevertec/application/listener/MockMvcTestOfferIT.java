...
import ru.clevertec.application.mockmvc.MockMvcTestConfiguration;
...
@TestExecutionListeners(
        listeners = CustomTaskExecutionListener.class,
...
class MockMvcTestOfferIT {
    ...
    void testConverter() {
        ...
        //when
        Integer convertValue = conversionService.convert(source, Integer.class);

        //then
        Assertions.assertThat(convertValue)
                .isNotNull()
